...
define('ULP_VERSION', 5.94);
define('ULP_EXPORT_VERSION', '0001');
define('ULP_API_URL', 'http://halfdata.com/updates/');
...
register_deactivation_hook(__FILE__, array("ulp_class", "deactivate"));
...
class ulp_class {
	...
	function wpml_parse_popup_id($_popup_id, $_default_all_value = '') {
		$popup_id = $_popup_id;
		...
		if (!defined('ICL_LANGUAGE_CODE')) $popup_id = $popups['all'];
			...
			if (array_key_exists(ICL_LANGUAGE_CODE, $popups)) $popup_id = $popups[ICL_LANGUAGE_CODE];
