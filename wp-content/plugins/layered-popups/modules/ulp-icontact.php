				...
				<table class="ulp_useroptions">
					...
					<tr>
						...
						<td>
							...
							<br /><em>'.__('Enter your List ID. You can get List ID from', 'ulp').' <a href="'.admin_url('admin.php').'?action=ulp-icontact-lists&appid='.base64_encode($popup_options['icontact_appid']).'&user='.base64_encode($popup_options['icontact_apiusername']).'&pass='.base64_encode($popup_options['icontact_apipassword']).'" class="thickbox" id="ulp_icontact_lists" title="'.__('Available Lists', 'ulp').'">'.__('this table', 'ulp').'</a>.</em>
						</td>
					</tr>
					<tr>
						<th>'.__('Confirmation Message ID', 'ulp').' <span class="ulp-badge ulp-badge-beta">Beta</span>:</th>
						<td>
							...
							<br /><em>'.__('Indicates which email should be used as the confirmation-request message. You can get Message ID from', 'ulp').' <a href="'.admin_url('admin.php').'?action=ulp-icontact-messages&appid='.base64_encode($popup_options['icontact_appid']).'&user='.base64_encode($popup_options['icontact_apiusername']).'&pass='.base64_encode($popup_options['icontact_apipassword']).'" class="thickbox" id="ulp_icontact_messages" title="'.__('Available Messages', 'ulp').'">'.__('this table', 'ulp').'</a>. '.__('Leave the field empty, if you do not need confirmation functionality.', 'ulp').'</em>
							<script>
