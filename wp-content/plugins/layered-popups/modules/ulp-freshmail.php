				...
				<table class="ulp_useroptions">
					...
					<tr>
						...
						<td>
							...
							<br /><em>'.__('Enter your List ID. You can get List ID from', 'ulp').' <a href="'.admin_url('admin.php').'?action=ulp-freshmail-lists&key='.base64_encode($popup_options['freshmail_key']).'&secret='.base64_encode($popup_options['freshmail_secret']).'" class="thickbox" id="ulp_freshmail_lists" title="'.__('Available Lists', 'ulp').'">'.__('this table', 'ulp').'</a>.</em>
							<script>
