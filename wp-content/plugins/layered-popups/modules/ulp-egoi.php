				...
				<table class="ulp_useroptions">
					...
					<tr>
						...
						<td>
							...
							<br /><em>'.__('Enter your List ID. You can get List ID from', 'ulp').' <a href="'.admin_url('admin.php').'?action=ulp-egoi-lists&key='.base64_encode($popup_options['egoi_api_key']).'" class="thickbox" id="ulp_egoi_lists" title="'.__('Available Lists', 'ulp').'">'.__('this table', 'ulp').'</a>.</em>
							<script>
