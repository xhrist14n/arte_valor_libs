				...
				<table class="ulp_useroptions">
					...
					<tr>
						...
						<td>
							...
							<br /><em>'.__('Enter your Form ID. Please do not forget to enable API access to this form as described ', 'ulp').' <a href="http://directmailmac.com/support/article/349-authentication-and-authorization" class="thickbox">here</a> (step #2).</em>
						</td>
					</tr>
				</table>';
	}
